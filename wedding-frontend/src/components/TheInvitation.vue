<template>
<div id="the-invitation" class="flex h-3/4">
  <div class="relative w-full mx-auto max-w-2xl">
    <svg class="w-full" viewBox="0 0 572 406" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
      ...
      <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          <g id="envelope" transform="translate(1.661885, 2.646000)">
              ...
              <g id="envelopeFlap" class="origin-top" transform="translate(283.000000, 118.583770) scale(1, -1) translate(-283.000000, -118.583770) ">
    ...
    <img @load="addEnvelopeAnimation" id="waxSeal" class="absolute top-1/2 -translate-y-[40%] left-1/2 -translate-x-1/2 w-[18%]" :src="require('@/assets/waxSeal.webp')">
  </div>
</div>
</template>
