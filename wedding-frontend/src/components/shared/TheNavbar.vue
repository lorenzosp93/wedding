  ...
  <nav class="sticky bg-neutral border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-darkNeutral">
    <div class="container flex flex-wrap justify-between items-center mx-auto">
      ...
      <div :class="{hidden: !menu}" class="z-30 w-full md:block md:w-auto top-10 left-0" id="navbarDefault">
        <ul class="flex flex-col py-4 mt-4 border-accent md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-neutral  md:dark:bg-darkNeutral">
          <li>
            <router-link @click="dropInfo = false" to="/" class="block py-2 pr-4 pl-3 text-primary rounded hover:bg-secondary md:hover:bg-transparent md:border-0 md:hover:text-accent md:p-0 dark:text-darkPrimary  dark:hover:bg-darkNeutral dark:hover:text-darkPrimary md:dark:hover:bg-transparent" aria-current="page">{{ $t('shared.thenavbar.home') }}</router-link>
          </li>
          <li>
            <div class="relative text-primary rounded hover:bg-secondary md:hover:bg-transparent md:border-0 md:hover:text-accent  dark:text-darkPrimary  dark:hover:bg-darkNeutral dark:hover:text-darkPrimary md:dark:hover:bg-transparent z-40">
              ...
              <div v-show="dropInfo" class="md:absolute right-0 pt-2 origin-top-right bg-neutral dark:bg-darkNeutral text-primary md:flex md:flex-row">
                <router-link v-for="type in infoTypes" :to="`/info/${type}`" :key="type" @click="{activateType(type); dropInfo = false}" class="block md:flex px-5 py-2 text-sm rounded-lg hover:bg-secondary md:hover:bg-transparent md:hover:text-accent  dark:text-darkPrimary  dark:hover:bg-darkNeutral dark:hover:text-darkPrimary md:dark:hover:bg-transparent" >
                  {{ type }}
                </router-link>
              </div>
            </div>
          ...
          <li>
            <router-link @click="dropInfo = false" to="/inbox" class="block py-2 pr-4 pl-3 text-primary rounded hover:bg-secondary md:hover:bg-transparent md:border-0 md:hover:text-accent md:p-0 dark:text-darkPrimary  dark:hover:bg-darkNeutral dark:hover:text-darkPrimary md:dark:hover:bg-transparent">{{ $t('shared.thenavbar.inbox') }}</router-link>
          </li>
          <li>
            <router-link @click="dropInfo = false" to="/gallery" class="block py-2 pr-4 pl-3 text-primary rounded hover:bg-secondary md:hover:bg-transparent md:border-0 md:hover:text-accent md:p-0 dark:text-darkPrimary  dark:hover:bg-darkNeutral dark:hover:text-darkPrimary md:dark:hover:bg-transparent">{{ $t('shared.thenavbar.gallery') }}</router-link>
          </li>
          <li>
            <router-link @click="dropInfo = false" to="/profile" class="block py-2 pr-4 pl-3 text-primary rounded hover:bg-secondary md:hover:bg-transparent md:border-0 md:hover:text-accent md:p-0 dark:text-darkPrimary  dark:hover:bg-darkNeutral dark:hover:text-darkPrimary md:dark:hover:bg-transparent">{{ $t('shared.thenavbar.profile') }}</router-link>
          </li>
        </ul>
      </div>
    </div>
