        ...
        <ul class="flex flex-col py-4 mt-4 md:flex-row md:space-x-8 md:mt-0 font-medium  duration-500 ease-out md:transition-none">
          ...
          <li>
            <div id="navbar-information" class="relative rounded cursor-pointer">
              ...
              <ul v-show="dropInfo" class="md:absolute right-0 top-5 pt-2 origin-top-right bg-neutral dark:bg-darkNeutral flex flex-row z-30">
